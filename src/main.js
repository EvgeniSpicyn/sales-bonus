...
function analyzeSalesData(data, options) {
    ...
    topSellers.forEach((seller, index) => {
        seller.bonus = calculateBonus(index, 
            topSellers.length, seller);
        const productSeller = Object.entries(seller.products_sold).map(([sku, quantity]) => ({
            sku: sku,
            quantity: quantity
        }));
